...
## Acceptance criteria
- Running `loopy --dry-run --prompt @examples/PRD.md --agent "cursor-agent"` produces a `.loopy/PROMPT.md` that contains this file’s contents under a “Plan seed (PRD)” section.
