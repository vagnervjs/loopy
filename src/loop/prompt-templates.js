...
const DEFAULT_PLAN_PROMPT_TEMPLATE = [
  ...
  "- When generating phase configurations, prefer stop_on: tests_pass over stop_on: all_checked for any phase that involves code changes (implementation, tests, build, verification).",
  "- Reserve stop_on: all_checked only for documentation-only or planning-only phases with no code impact.",
  "",
  "## Current Plan",
  "{{plan}}",
  "",
