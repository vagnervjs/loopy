...
async function generatePrdWithAgent(agentCommand, seedText, { extraContext, cwd, noColor } = {}) {
  ...
  const result = await runShellCommand(cmd, prompt, DEFAULTS.maxOutputBytes, { cwd, noColor });
  ...
  return { text: cleaned, raw: output };
}
